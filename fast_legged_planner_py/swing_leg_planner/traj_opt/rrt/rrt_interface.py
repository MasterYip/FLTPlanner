...
LastEditTime: 2023-12-04 12:24:13
FilePath: \Fast-Legged-Planner-Test\fast_legged_planner_py\swing_leg_planner\traj_opt\rrt\rrt_interface.py
...
class OMPL_HITSpiderCfg_SearchSpace(object):
    def __init__(self, robot_interface, map_interface,
        ...
        # OMPL space
        dimen = dimension_lengths.shape[0]
        self.dimen = dimen
        # Create an instance of the state space
        self.space = base.RealVectorStateSpace(dimen)
        # Set bounds for the state space
        bounds = base.RealVectorBounds(dimen)
        # FIXME:
