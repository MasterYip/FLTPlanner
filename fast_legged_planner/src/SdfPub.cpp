...
#include "fast_legged_planner/SdfPub.hpp"
...
namespace grid_map_demos
{
  ...
  void SdfDemo::callback(const grid_map_msgs::GridMap &message)
  {
    ...
    grid_map::GridMapRosConverter::toPointCloud(sdf, pointCloud2Msg, 1, [](float sdfValue)
                                                { return sdfValue > 0.0; });
