...
if __name__ == '__main__':
    ...
    t = 0
    # foot_end_pos = np.array([[0.42, -0.42, -0.3],
    #                          [0., -0.46, -0.3],
    #                          [-0.42, -0.42, -0.3],
    #                          [0.42, 0.42, -0.3],
    #                          [0., 0.46, -0.3],
    ...
    foot_end_pos = np.array([[0.35350208, -0.22998902, -0.3],
                             [0.05350208, -0.28998902, -0.3],
                             [-0.35349792, -0.22998928, -0.3],
                             [0.35350208,  0.2299882, -0.3],
                             [0.05350208,  0.2899882, -0.3],
                             [-0.35350133, 0.22998794, -0.3]])
