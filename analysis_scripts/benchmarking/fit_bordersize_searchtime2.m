function [fitresult, gof] = fit_bordersize_searchtime2(bordersize, tottime)
...
legend( h, '搜索时间-交线边界长度', '指数拟合曲线', '下界(指数拟合曲线)', '上界(指数拟合曲线)', 'Location', 'NorthEast', 'Interpreter', 'none' );
% 为坐标区加标签
