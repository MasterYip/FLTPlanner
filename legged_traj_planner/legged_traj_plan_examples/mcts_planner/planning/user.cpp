...
namespace USER
{
    ...
    const float workspaceReductionDis =  std::stof(USER::configMap.at("workspaceReductionDis_"));

    const float staticStabilityMarginThreshold = std::stof(USER::configMap.at("staticStabilityMarginThreshold"));

    const float norminalFootStepLengthInWorkspace = std::stof(USER::configMap.at("norminalFootStepLengthInWorkspace"));

    const float kinematicMargin = std::stof(USER::configMap.at("kinematicMargin"));


    // const float nominal_y_shift = std::stof(USER::configMap.at("nominal_y_shift"));

    // const float norminalTrunkHeight = std::stof(USER::configMap.at("norminalTrunkHeight"));
