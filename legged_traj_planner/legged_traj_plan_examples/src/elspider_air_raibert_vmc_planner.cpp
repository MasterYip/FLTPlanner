/**
 * @file elspider_air_raibert_vmc_planner.cpp
...
#include "legged_traj_plan_examples/elspider_air_planner/ElSpiderAirRaibertVMCPlanner.h"

int main(int argc, char **argv)
{
    ros::init(argc, argv, "elspider_air_raibert_vmc_planner");
    ros::NodeHandle nh("~");
