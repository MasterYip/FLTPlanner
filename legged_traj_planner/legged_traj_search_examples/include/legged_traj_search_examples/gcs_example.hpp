...
#include <legged_traj_search_examples/GCSExampleConfig.h>
...
private:
    ...
    // Dyn reconf
    dynamic_reconfigure::Server<legged_traj_search_examples::GCSExampleConfig> server;
    dynamic_reconfigure::Server<legged_traj_search_examples::GCSExampleConfig>::CallbackType f;
...
public:
    ...
    void dyn_reconf_callback(legged_traj_search_examples::GCSExampleConfig &config, uint32_t level);
