...
#include "legged_traj_search_examples/cvx_trajopt/cvx_trajopt.h"
...
void CVX_TrajOpt::dyn_reconf_callback(legged_traj_search_examples::CvxTrajOptConfig &config, uint32_t level)
{
